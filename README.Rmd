...
or [RSelenium](https://docs.ropensci.org/RSelenium/). It is inspired by Java's [Selenide](https://selenide.org/) and Python's [Selene](https://yashaka.github.io/selene/).
